...
private void layoutComponents() {
    ...
    private JPanel createProgettiPanel() {
    ...
    private JPanel createLottiPanel() {
        JPanel panel = new JPanel(new BorderLayout(10, 10));
    ...
    private void handleGeneraReport() {
    ...
    private void handleModificaProgetto(String idProgetto, int row) {
        try {
            Progetto progettoSelezionato = controller.getProgettoById(idProgetto);
    ...
    private void handleModificaAttivita(Progetto progetto) {
    ...
    private void handleModificaColtivatori(Progetto progetto) {

...
public class Controller {
    ...
    public void creaProgettoOld(Progetto progetto, List<Coltura> colture) throws SQLException {
        
        if (progetto == null || progetto.getProprietario() == null || progetto.getLotto() == null) {
            throw new IllegalArgumentException("Impossibile creare il progetto: mancano Proprietario o Lotto.");
        }
        ...
        if (colture != null && !colture.isEmpty()) {
            ...
            progettoDAO.addColture(progetto.getIdProgetto(), colture); 
        }
    }
